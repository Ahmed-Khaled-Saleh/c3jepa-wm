...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/06b_utils.checkpointer.ipynb.

# %% auto #0
__all__ = ['BaseCheckpointer', 'RetrospectiveCheckpointer']

# %% ../../nbs/06b_utils.checkpointer.ipynb #5a6a2472
import os
import pathlib
...
# %% ../../nbs/06b_utils.checkpointer.ipynb #c381b503
class BaseCheckpointer:
    def __init__(self, project_name, ckp_dir, slurm_jobid, agent_id= None, rank=0):
        ...
        self.checkpoint_dir = os.path.join(self.checkpoint_dir, project_name, slurm_jobid, f"agent_{self.agent_id}")
...
# %% ../../nbs/06b_utils.checkpointer.ipynb #74f124ac
class RetrospectiveCheckpointer(BaseCheckpointer):
    def __init__(self, project_name, ckp_dir, slurm_jobid, agent_id= None, rank= 0, n_best=3):
        super().__init__(project_name, ckp_dir, slurm_jobid, agent_id, rank)
