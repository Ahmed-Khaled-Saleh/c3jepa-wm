...
__all__ = ['normalize', 'generate_data_marl_grid_np', 'generate_data_marl_grid_h52', 'collect_one_rollout_h5',
           'collect_one_rollout_ds', 'generate_parallel', 'combine_npz_files']

# %% ../../nbs/01a_data.generate_data.ipynb #b6666a02
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/01a_data.generate_data.ipynb #f27cdf18
def normalize(img):
    return (img - img.min()) / (img.max() - img.min())


# %% ../../nbs/01a_data.generate_data.ipynb #23f8d256
import numpy as np
import os
...
# %% ../../nbs/01a_data.generate_data.ipynb #20fbac6d
import numpy as np
import os
import h5py
from mawm.envs.marl_grid import make_env
...
# %% ../../nbs/01a_data.generate_data.ipynb #0f85c527
import os
import numpy as np
import h5py
from mawm.envs.marl_grid import make_env
...
# %% ../../nbs/01a_data.generate_data.ipynb #1812d8cd
import os
import numpy as np
...
# %% ../../nbs/01a_data.generate_data.ipynb #dfd9140c
...
# %% ../../nbs/01a_data.generate_data.ipynb #bd4e23bf
import numpy as np
