...
# %% auto #0
__all__ = ['ds', 'MultiAgentPOVDataset', 'MultiAgentWorldModelDataset']
...
# %% ../../nbs/01a_data.datasets.ipynb #7c186ba7
...
# %% ../../nbs/01a_data.datasets.ipynb #6dd4f366
sample['sender_csi'].shape
