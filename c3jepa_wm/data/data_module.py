...
# %% ../../nbs/01c_data.data_module.ipynb #1d8deede
import os
...
# %% ../../nbs/01c_data.data_module.ipynb #b22bd5e8
class DataModule:
    def __init__(self,
                 data_dir: str, 
                 batch_size: int = 64, 
...
# %% ../../nbs/01c_data.data_module.ipynb #e34fc85a
...
# %% ../../nbs/01c_data.data_module.ipynb #9876cf41
