...
# %% ../../nbs/01c_data.data_module.ipynb #f39570d0
import os
...
# %% ../../nbs/01c_data.data_module.ipynb #0fe41065
class DataModule:
    def __init__(self,
                 data_dir: str, 
                 batch_size: int = 64, 
...
# %% ../../nbs/01c_data.data_module.ipynb #a34987b7
...
# %% ../../nbs/01c_data.data_module.ipynb #7d80349e
