...
# %% ../../nbs/01c_data.data_module.ipynb #250eb17c
import os
...
# %% ../../nbs/01c_data.data_module.ipynb #b2cc23b8
class DataModule:
    def __init__(self,
                 data_dir: str, 
                 batch_size: int = 64, 
...
# %% ../../nbs/01c_data.data_module.ipynb #225ffdaa
...
# %% ../../nbs/01c_data.data_module.ipynb #3e2bc1f2
