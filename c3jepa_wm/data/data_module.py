...
# %% ../../nbs/01c_data.data_module.ipynb #3e6f7e0a
import os
...
# %% ../../nbs/01c_data.data_module.ipynb #149d184e
class DataModule:
    def __init__(self,
                 data_dir: str, 
                 batch_size: int = 64, 
...
# %% ../../nbs/01c_data.data_module.ipynb #f74fc44d
...
# %% ../../nbs/01c_data.data_module.ipynb #0a4ee193
