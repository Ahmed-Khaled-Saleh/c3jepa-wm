...
# %% ../../nbs/01c_data.data_module.ipynb #f7cb39ba
import os
...
# %% ../../nbs/01c_data.data_module.ipynb #42634eae
class DataModule:
    def __init__(self,
                 data_dir: str, 
                 batch_size: int = 64, 
...
# %% ../../nbs/01c_data.data_module.ipynb #959c9dc1
...
# %% ../../nbs/01c_data.data_module.ipynb #f0daefca
