...
# %% ../../nbs/01c_data.data_module.ipynb #486bc080
import os
...
# %% ../../nbs/01c_data.data_module.ipynb #7b7477b2
class DataModule:
    def __init__(self,
                 data_dir: str, 
                 batch_size: int = 64, 
...
# %% ../../nbs/01c_data.data_module.ipynb #2d2b7f1a
...
# %% ../../nbs/01c_data.data_module.ipynb #e3e272c2
