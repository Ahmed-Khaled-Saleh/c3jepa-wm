...
# %% ../../nbs/01c_data.data_module.ipynb #f36b10d6
import os
...
# %% ../../nbs/01c_data.data_module.ipynb #f15d46ca
class DataModule:
    def __init__(self,
                 data_dir: str, 
                 batch_size: int = 64, 
...
# %% ../../nbs/01c_data.data_module.ipynb #03c4fab8
...
# %% ../../nbs/01c_data.data_module.ipynb #0f5601cc
