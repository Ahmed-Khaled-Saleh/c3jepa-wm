...
# %% ../../nbs/01c_data.data_module.ipynb #6ea6179f
import os
...
# %% ../../nbs/01c_data.data_module.ipynb #c361e123
class DataModule:
    def __init__(self,
                 data_dir: str, 
                 batch_size: int = 64, 
...
# %% ../../nbs/01c_data.data_module.ipynb #8e559ce3
...
# %% ../../nbs/01c_data.data_module.ipynb #f65a1def
