...
# %% ../../nbs/05c_trainers.control.ipynb #3db9862e
import math
import torch
import os
...
# %% ../../nbs/05c_trainers.control.ipynb #e5fb3393
...
# %% ../../nbs/05c_trainers.control.ipynb #2c3b95f0
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05c_trainers.control.ipynb #67c22b2c
    ...
    def train_epoch(self, epoch):
        ...
        for batch_idx, batch in enumerate(self.train_loader):
            ...
            power_loss = self.power_net.loss_fn(
                self.model, B, T, ctx_emb, ctx_act,
...
# %% ../../nbs/05c_trainers.control.ipynb #2b19fee9
@patch
