...
# %% ../../nbs/05c_trainers.control.ipynb #fc62f05e
import math
import torch
import os
...
# %% ../../nbs/05c_trainers.control.ipynb #ff9faa98
...
# %% ../../nbs/05c_trainers.control.ipynb #6c56660e
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05c_trainers.control.ipynb #445b8437
...
# %% ../../nbs/05c_trainers.control.ipynb #e0fe5798
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #0bae14ee
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #3bc6aae0
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #5942c875
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #973b812e
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #0b366c86
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #da32dcd3
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #220790db
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #edbe9f23
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #2c8be767
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #b364959c
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #93480178
@patch
