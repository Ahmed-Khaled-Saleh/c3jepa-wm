...
# %% ../../nbs/05c_trainers.control.ipynb #db5827b6
import math
import torch
import os
...
# %% ../../nbs/05c_trainers.control.ipynb #23b8a6af
...
# %% ../../nbs/05c_trainers.control.ipynb #a408a5b2
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05c_trainers.control.ipynb #0c36242d
...
# %% ../../nbs/05c_trainers.control.ipynb #bdbffac0
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #e1db5b0e
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #faeb058f
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #9a20025b
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #f50719a9
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #83a2c750
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #c1e3714c
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #5c01f648
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #bc7cb445
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #0485a71d
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #34c0f751
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #643d805d
@patch
