...
# %% ../../nbs/05c_trainers.control.ipynb #dc858420
import math
import torch
import os
...
# %% ../../nbs/05c_trainers.control.ipynb #1da718b9
...
# %% ../../nbs/05c_trainers.control.ipynb #ec9144a0
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05c_trainers.control.ipynb #fa74069e
...
# %% ../../nbs/05c_trainers.control.ipynb #f8646ccf
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #6450c318
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #59a6b8cb
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #50c5297a
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #cccfbf45
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #ccf9ae8a
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #3f2a8fd0
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #02f2b385
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #32c002f6
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #c3dcc4a7
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #ad6531a3
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #b0f34720
@patch
