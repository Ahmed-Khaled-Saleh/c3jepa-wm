...
# %% ../../nbs/05c_trainers.control.ipynb #fd379a33
import math
import torch
import os
...
# %% ../../nbs/05c_trainers.control.ipynb #1289af9b
...
# %% ../../nbs/05c_trainers.control.ipynb #ce5e4a99
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05c_trainers.control.ipynb #da75b631
...
# %% ../../nbs/05c_trainers.control.ipynb #ba8bffcb
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #28abc24b
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #b461b0e4
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #ba3c60ee
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #afaf47cd
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #60abdfa2
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #01c9c364
@patch
...
# %% ../../nbs/05c_trainers.control.ipynb #fcd3f3af
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #f43b42f0
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #28e5639e
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #a65c586d
@patch
@torch.no_grad()
...
# %% ../../nbs/05c_trainers.control.ipynb #c9067272
@patch
