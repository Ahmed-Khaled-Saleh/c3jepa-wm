...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #3d9fbe64
import torch
import os
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #69d7eadd
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #f0c1441a
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #2fd703a8
@patch
