...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #b74c5cca
import torch
import os
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #9cd2344a
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #b44f0f0a
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #e7fd1cb2
@patch
