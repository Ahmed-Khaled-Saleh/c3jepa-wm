...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #852e8eac
import torch
import os
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #c8f2810f
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #caac6e4a
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #7d1bb7d8
@patch
