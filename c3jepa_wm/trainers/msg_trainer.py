...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #3f3ab766
import torch
import os
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #5ce47ee7
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #f3a7fba1
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #8c06cc1e
@patch
