...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #02a67cbd
import torch
import os
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #9708bcdd
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #fd0dad2e
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #2ac908c0
@patch
