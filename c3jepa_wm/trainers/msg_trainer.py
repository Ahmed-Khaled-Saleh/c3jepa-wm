...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #150ca34a
import torch
import os
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #4f7d33f3
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #f4424dcd
...
# %% ../../nbs/05a_trainers.msg_trainer.ipynb #9bae145c
@patch
