...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/05b_trainers.control.ipynb.

# %% auto #0
__all__ = ['TrainerScheduler', 'BaseTrainer', 'WMTrainer']

# %% ../../nbs/05b_trainers.control.ipynb #3db9aafc
import math
import torch
import os
...
# %% ../../nbs/05b_trainers.control.ipynb #ca7cebcd
...
# %% ../../nbs/05b_trainers.control.ipynb #4e7ea434
class BaseTrainer:
    def __init__(self, 
                 data_module, 
                 device, 
...
# %% ../../nbs/05b_trainers.control.ipynb #e7684040
...
# %% ../../nbs/05b_trainers.control.ipynb #f450c2ad
@patch
...
# %% ../../nbs/05b_trainers.control.ipynb #d573b6cb
@patch
@torch.no_grad()
...
# %% ../../nbs/05b_trainers.control.ipynb #18690828
@patch
@torch.no_grad()
...
# %% ../../nbs/05b_trainers.control.ipynb #6faf897a
@patch
...
# %% ../../nbs/05b_trainers.control.ipynb #03d1bd4f
@patch
...
# %% ../../nbs/05b_trainers.control.ipynb #c5489073
@patch
...
# %% ../../nbs/05b_trainers.control.ipynb #bf42ff63
@patch
...
# %% ../../nbs/05b_trainers.control.ipynb #35811604
@patch
@torch.no_grad()
...
# %% ../../nbs/05b_trainers.control.ipynb #1a5fc133
@patch
@torch.no_grad()
...
# %% ../../nbs/05b_trainers.control.ipynb #6c2c7e17
@patch
@torch.no_grad()
...
# %% ../../nbs/05b_trainers.control.ipynb #d512cfae
@patch
@torch.no_grad()
...
# %% ../../nbs/05b_trainers.control.ipynb #b467e9d0
@patch
