...
# %% ../../nbs/04a_optimizers.utils.ipynb #c2d16e8a
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #d58ab082
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #414f1d6e
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #178822bb
...
# %% ../../nbs/04a_optimizers.utils.ipynb #6f2bf4b8
...
# %% ../../nbs/04a_optimizers.utils.ipynb #f4b0adcb
import torch
def init_opt(
    cfg,
    models,
