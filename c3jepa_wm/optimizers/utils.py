...
# %% ../../nbs/04a_optimizers.utils.ipynb #d06fc9e4
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #ca9b0e49
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #00dbe879
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #a3218a70
...
# %% ../../nbs/04a_optimizers.utils.ipynb #ce4c2594
...
# %% ../../nbs/04a_optimizers.utils.ipynb #3e55b639
import torch
def init_opt(
    cfg,
    models,
