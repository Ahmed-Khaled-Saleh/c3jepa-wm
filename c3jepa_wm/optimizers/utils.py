...
# %% ../../nbs/04a_optimizers.utils.ipynb #d914c43d
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #49aabf41
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #560c0133
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #a44534b0
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d6b2e9ae
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d54a4b93
import torch
def init_opt(
    cfg,
    models,
