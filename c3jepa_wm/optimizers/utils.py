...
# %% ../../nbs/04a_optimizers.utils.ipynb #a84518eb
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #a19731a4
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #dfab0991
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #97a20bbc
...
# %% ../../nbs/04a_optimizers.utils.ipynb #804bb8e3
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d9d47cb5
import torch
def init_opt(
    cfg,
    models,
