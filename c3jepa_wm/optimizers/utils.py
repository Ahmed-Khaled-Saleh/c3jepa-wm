...
# %% ../../nbs/04a_optimizers.utils.ipynb #5765afa8
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #385c5872
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #3b626ccb
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #49ae8bc2
...
# %% ../../nbs/04a_optimizers.utils.ipynb #f21333ea
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d6712fee
import torch
def init_opt(
    cfg,
    models,
