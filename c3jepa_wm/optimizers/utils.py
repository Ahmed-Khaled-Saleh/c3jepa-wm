...
# %% ../../nbs/04a_optimizers.utils.ipynb #498b9e06
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #b486c74f
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #7d46766e
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #3ebad400
...
# %% ../../nbs/04a_optimizers.utils.ipynb #742e85d2
...
# %% ../../nbs/04a_optimizers.utils.ipynb #f47365b9
import torch
def init_opt(
    cfg,
    models,
