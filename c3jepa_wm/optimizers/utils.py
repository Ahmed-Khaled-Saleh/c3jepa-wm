...
# %% ../../nbs/04a_optimizers.utils.ipynb #8a44f7ee
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #ea3ec3fa
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #ac63d468
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #09dc6adf
...
# %% ../../nbs/04a_optimizers.utils.ipynb #6db573b8
...
# %% ../../nbs/04a_optimizers.utils.ipynb #e76621e0
import torch
def init_opt(
    cfg,
    models,
