...
# %% ../../nbs/04a_optimizers.utils.ipynb #0ae084da
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #32ed4d25
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #52ca45cd
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #867a8696
...
# %% ../../nbs/04a_optimizers.utils.ipynb #3604d8f5
...
# %% ../../nbs/04a_optimizers.utils.ipynb #95be01c6
import torch
def init_opt(
    cfg,
    models,
