...
# %% ../../nbs/04a_optimizers.utils.ipynb #adbab75f
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #33622cdf
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #7d49c6c2
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #5a332e73
...
# %% ../../nbs/04a_optimizers.utils.ipynb #ccc33e63
...
# %% ../../nbs/04a_optimizers.utils.ipynb #a7e3d254
import torch
def init_opt(
    cfg,
    models,
