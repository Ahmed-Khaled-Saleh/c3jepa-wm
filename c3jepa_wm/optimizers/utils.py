...
# %% ../../nbs/04a_optimizers.utils.ipynb #cc40902d
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #72bedc81
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #9186fe5e
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #b88b68fb
...
# %% ../../nbs/04a_optimizers.utils.ipynb #1e90eff7
...
# %% ../../nbs/04a_optimizers.utils.ipynb #ee8f3c15
import torch
def init_opt(
    cfg,
    models,
