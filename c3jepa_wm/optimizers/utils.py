...
# %% ../../nbs/04a_optimizers.utils.ipynb #9e16bbec
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #23bc1b4a
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #74940781
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #2b10dd74
...
# %% ../../nbs/04a_optimizers.utils.ipynb #b9954c9e
...
# %% ../../nbs/04a_optimizers.utils.ipynb #ed5e0343
import torch
def init_opt(
    cfg,
    models,
