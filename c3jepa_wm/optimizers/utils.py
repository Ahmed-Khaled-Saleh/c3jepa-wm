...
# %% ../../nbs/04a_optimizers.utils.ipynb #db2dbfef
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #becd6e75
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #daa73084
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #01af3edd
...
# %% ../../nbs/04a_optimizers.utils.ipynb #ccadb82f
...
# %% ../../nbs/04a_optimizers.utils.ipynb #2d67cef9
import torch
def init_opt(
    cfg,
    models,
