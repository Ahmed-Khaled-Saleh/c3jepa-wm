...
# %% ../../nbs/04a_optimizers.utils.ipynb #ca3a8730
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #0290b8bb
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #b96538b5
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #35f87a1b
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d2363ca0
...
# %% ../../nbs/04a_optimizers.utils.ipynb #1b3d06c6
import torch
def init_opt(
    cfg,
    models,
