...
# %% ../../nbs/04a_optimizers.utils.ipynb #f952241b
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #7c7a3322
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #88a25569
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #0dd59ac6
...
# %% ../../nbs/04a_optimizers.utils.ipynb #365d657b
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d85ba31c
import torch
def init_opt(
    cfg,
    models,
