...
# %% ../../nbs/04a_optimizers.utils.ipynb #bf2b39bf
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #2ba6057d
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #5261d602
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #d998cced
...
# %% ../../nbs/04a_optimizers.utils.ipynb #5f89cdbe
...
# %% ../../nbs/04a_optimizers.utils.ipynb #eb48b4ae
import torch
def init_opt(
    cfg,
    models,
