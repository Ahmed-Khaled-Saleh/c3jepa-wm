...
# %% ../../nbs/04a_optimizers.utils.ipynb #3fb7edf0
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #671055a9
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #255d76c8
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #6955a4d0
...
# %% ../../nbs/04a_optimizers.utils.ipynb #0dfbea9e
...
# %% ../../nbs/04a_optimizers.utils.ipynb #a0b88495
import torch
def init_opt(
    cfg,
    models,
