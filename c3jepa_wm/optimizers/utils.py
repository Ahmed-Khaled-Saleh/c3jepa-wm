...
# %% ../../nbs/04a_optimizers.utils.ipynb #55d2a855
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #b2c0b8b1
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #620c7df1
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #4afb45bd
...
# %% ../../nbs/04a_optimizers.utils.ipynb #a047dfb4
...
# %% ../../nbs/04a_optimizers.utils.ipynb #729260fa
import torch
def init_opt(
    cfg,
    models,
