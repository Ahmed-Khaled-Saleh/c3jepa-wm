...
# %% ../../nbs/04a_optimizers.utils.ipynb #2651ecde
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #b47a40b8
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #91da6bf4
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #e6194f0b
...
# %% ../../nbs/04a_optimizers.utils.ipynb #9156f0b1
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d7c4bfb4
import torch
def init_opt(
    cfg,
    models,
