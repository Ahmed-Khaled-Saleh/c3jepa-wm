...
# %% ../../nbs/04a_optimizers.utils.ipynb #d8a866c8
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #fc326d48
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #811ec0fa
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #183eea23
...
# %% ../../nbs/04a_optimizers.utils.ipynb #113cccf4
...
# %% ../../nbs/04a_optimizers.utils.ipynb #70f09f01
import torch
def init_opt(
    cfg,
    models,
