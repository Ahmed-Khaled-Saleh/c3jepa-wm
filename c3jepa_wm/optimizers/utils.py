...
# %% ../../nbs/04a_optimizers.utils.ipynb #33f9d519
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #357c6d8a
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #6ac647f5
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #d03d028e
...
# %% ../../nbs/04a_optimizers.utils.ipynb #eff233e5
...
# %% ../../nbs/04a_optimizers.utils.ipynb #9a87110b
import torch
def init_opt(
    cfg,
    models,
