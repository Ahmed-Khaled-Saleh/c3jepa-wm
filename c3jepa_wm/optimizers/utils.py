...
# %% ../../nbs/04a_optimizers.utils.ipynb #df9bbad6
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #6be4e060
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #86f62c71
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #e3a12f72
...
# %% ../../nbs/04a_optimizers.utils.ipynb #fe492df8
...
# %% ../../nbs/04a_optimizers.utils.ipynb #effb6ddb
import torch
def init_opt(
    cfg,
    models,
