...
# %% ../../nbs/04a_optimizers.utils.ipynb #6ea1a0a5
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #9359a549
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #0c06aa36
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #dcdcfb2b
...
# %% ../../nbs/04a_optimizers.utils.ipynb #0c365735
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d4f37437
import torch
def init_opt(
    cfg,
    models,
