...
# %% ../../nbs/04a_optimizers.utils.ipynb #d8f59f8c
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #a3ce866b
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #f6023e9d
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #16cd63dd
...
# %% ../../nbs/04a_optimizers.utils.ipynb #51b79636
...
# %% ../../nbs/04a_optimizers.utils.ipynb #f78a5e67
import torch
def init_opt(
    cfg,
    models,
