...
# %% ../../nbs/04a_optimizers.utils.ipynb #73e2c402
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #7b601ec9
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #9fa592e4
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #7ed381f4
...
# %% ../../nbs/04a_optimizers.utils.ipynb #0fc7c85a
...
# %% ../../nbs/04a_optimizers.utils.ipynb #1d68e4a2
import torch
def init_opt(
    cfg,
    models,
