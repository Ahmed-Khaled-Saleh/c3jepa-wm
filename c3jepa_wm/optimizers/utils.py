...
# %% ../../nbs/04a_optimizers.utils.ipynb #0bf7b49a
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #0ad424c9
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #ab6dd8ce
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #f8501cc2
...
# %% ../../nbs/04a_optimizers.utils.ipynb #3f444ee7
...
# %% ../../nbs/04a_optimizers.utils.ipynb #d9471ade
import torch
def init_opt(
    cfg,
    models,
