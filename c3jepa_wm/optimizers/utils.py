...
# %% ../../nbs/04a_optimizers.utils.ipynb #726c9d06
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #9f925327
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #96bacf80
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #65693c1e
...
# %% ../../nbs/04a_optimizers.utils.ipynb #5fbb9bdd
...
# %% ../../nbs/04a_optimizers.utils.ipynb #e473d939
import torch
def init_opt(
    cfg,
    models,
