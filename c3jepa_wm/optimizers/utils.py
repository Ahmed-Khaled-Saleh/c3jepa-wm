...
# %% ../../nbs/04a_optimizers.utils.ipynb #be4e236a
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #1fbee0d9
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #4499f971
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #2270c931
...
# %% ../../nbs/04a_optimizers.utils.ipynb #f3431280
...
# %% ../../nbs/04a_optimizers.utils.ipynb #74c4fec0
import torch
def init_opt(
    cfg,
    models,
