...
# %% ../../nbs/04a_optimizers.utils.ipynb #4bfa8189
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #4b94a8f9
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #91256c56
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #5ac18d45
...
# %% ../../nbs/04a_optimizers.utils.ipynb #4f6148e8
...
# %% ../../nbs/04a_optimizers.utils.ipynb #8e628c1e
import torch
def init_opt(
    cfg,
    models,
