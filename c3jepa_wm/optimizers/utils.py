...
# %% ../../nbs/04a_optimizers.utils.ipynb #a7d7d4a3
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #cd4fc1d4
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #5ca1a68b
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #1415865e
...
# %% ../../nbs/04a_optimizers.utils.ipynb #3250447d
...
# %% ../../nbs/04a_optimizers.utils.ipynb #96c14d5b
import torch
def init_opt(
    cfg,
    models,
