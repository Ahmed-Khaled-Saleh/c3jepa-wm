...
# %% ../../nbs/04a_optimizers.utils.ipynb #10b22037
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #d5dff6da
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #60a68250
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #6651923a
...
# %% ../../nbs/04a_optimizers.utils.ipynb #0ce5e200
...
# %% ../../nbs/04a_optimizers.utils.ipynb #ec0bc8b9
import torch
def init_opt(
    cfg,
    models,
