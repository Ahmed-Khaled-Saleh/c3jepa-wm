...
# %% ../../nbs/04a_optimizers.utils.ipynb #fc5a0c2c
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #9cd3dc59
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #427efaf3
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #c860e405
...
# %% ../../nbs/04a_optimizers.utils.ipynb #309dae9a
...
# %% ../../nbs/04a_optimizers.utils.ipynb #9fa589f6
import torch
def init_opt(
    cfg,
    models,
