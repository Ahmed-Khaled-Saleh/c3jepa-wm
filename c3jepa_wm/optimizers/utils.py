...
# %% ../../nbs/04a_optimizers.utils.ipynb #91a251e2
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #249d83e0
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #cd589212
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #2e9d8cc0
...
# %% ../../nbs/04a_optimizers.utils.ipynb #3d80884d
...
# %% ../../nbs/04a_optimizers.utils.ipynb #b45dfde4
import torch
def init_opt(
    cfg,
    models,
