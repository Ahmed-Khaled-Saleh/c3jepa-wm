...
# %% ../../nbs/04a_optimizers.utils.ipynb #e4180eb9
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #f9a33fc8
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #330efb74
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #9f3193d5
...
# %% ../../nbs/04a_optimizers.utils.ipynb #a5729804
...
# %% ../../nbs/04a_optimizers.utils.ipynb #65800715
import torch
def init_opt(
    cfg,
    models,
