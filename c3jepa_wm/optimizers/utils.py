...
# %% ../../nbs/04a_optimizers.utils.ipynb #ee51ca58
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/04a_optimizers.utils.ipynb #b19598bb
from functools import partial
from torch.optim import Optimizer

# %% ../../nbs/04a_optimizers.utils.ipynb #26984d27
import importlib
def get_cls(module_name, class_name):
    module = importlib.import_module(module_name)
    return getattr(module, class_name)

# %% ../../nbs/04a_optimizers.utils.ipynb #ce7f4cf3
...
# %% ../../nbs/04a_optimizers.utils.ipynb #cdcc87d4
...
# %% ../../nbs/04a_optimizers.utils.ipynb #60a86ef8
import torch
def init_opt(
    cfg,
    models,
